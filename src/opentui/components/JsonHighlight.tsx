...
function tokenizeJson(value: unknown, indent = 0): JsonLine[] {
    ...
    if (Array.isArray(value)) {
        ...
        const lines: JsonLine[] = [[padToken(), { type: "punctuation", value: "[" }]];
